...
class czzParser {
  constructor (transforms = [], parent = null, isGlobal = false) {
    this.animations = []
    this.mediaQueries = []
    this.fontFaces = []
    this.decl = []
    ...
    this.addDecl([(parent != null ? '.' + parent : '') + '.' + this.namespace])
